...
if __name__ == "__main__":
    ...
    setupkw["url"] = "https://github.com/Erotemic/vimtk"
    setupkw["description"] = "Python backend for the vimtk plugin"
    ...
    setupkw["keywords"] = "vim, gvim, python"
    setupkw["include_package_data"] = True
    setupkw["package_data"] = {"vimtk": ["autoload/*.vim", "plugin/*.vim"]}
    setup(**setupkw)
